import{d as t,c as a,a as l,o as n}from"./vue.094f02a2.js";const p={class:"markdown-body"},e=l(`<h1>Tooltip</h1><h3>Intro</h3><p>Simple text prompt bubbles.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> <span class="hljs-string">&quot;quarkd/lib/tooltip&quot;</span>;
...
</code></pre><h3>Set tips Size</h3><p>The tips size of the bubble is controlled by the size property. Size supports 2 types: <code class="">large</code> and the default.</p><pre><code class="language-tsx">&lt;quark-tooltip placement=<span class="hljs-string">&quot;top&quot;</span> size=<span class="hljs-string">&quot;large&quot;</span> tips=<span class="hljs-string">&quot;bubble text&quot;</span>&gt;
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>large Size<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
&lt;/quark-tooltip&gt;
...
</code></pre><h3>Scroll To Close</h3><p>Controls whether to close when the page is scrolled through the scrollhidden property.</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">quark-tooltip</span>
  <span class="hljs-attr">placement</span>=<span class="hljs-string">&quot;top&quot;</span>
  <span class="hljs-attr">tips</span>=<span class="hljs-string">&quot;bubble text&quot;</span>
  <span class="hljs-attr">scrollhidden</span>
  <span class="hljs-attr">:open</span>=<span class="hljs-string">&quot;open&quot;</span>
  @<span class="hljs-attr">close</span>=<span class="hljs-string">&quot;close&quot;</span>
&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> @<span class="hljs-attr">click</span>=<span class="hljs-string">&quot;click&quot;</span>&gt;</span>top position<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
