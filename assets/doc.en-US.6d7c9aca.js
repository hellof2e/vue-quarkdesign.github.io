import{d as t,c as a,a as n,o as l}from"./vue.c8a6d761.js";const e={class:"markdown-body"},p=n(`<h1>Popupextra</h1><h3>Intro</h3><p>Used to display some content.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> <span class="hljs-string">&quot;quarkd/lib/popupextra&quot;</span>;
...
&lt;/script&gt;
</code></pre><h3>Custom Title</h3><p>Set <code class="">slot=&#39;title&#39;</code> to replace <code class="">title</code>.</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">quark-popupextra</span> <span class="hljs-attr">subtitle</span>=<span class="hljs-string">&quot;Sub title&quot;</span> <span class="hljs-attr">:open</span>=<span class="hljs-string">&quot;open&quot;</span> @<span class="hljs-attr">close</span>=<span class="hljs-string">&quot;open = false&quot;</span>&gt;</span>
