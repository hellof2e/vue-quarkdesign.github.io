...
</code></pre><p>You can also load the code from a CDN such as unpkg: <a href="https://unpkg.com/@webcomponents/webcomponentsjs@%5E2/">https://unpkg.com/@webcomponents/webcomponentsjs@^2/</a></p>`,16),p=[o],u={},d="",m=a({__name:"quickstart.en-US",setup(c,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(r,h)=>(e(),t("div",l,p))}});export{m as default,d as excerpt,u as frontmatter};
