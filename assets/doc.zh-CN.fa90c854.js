import{d as a,c as n,a as t,o as l}from"./vue.0d310fee.js";const p={class:"markdown-body"},c=t(`<h1>ActionSheet</h1><h3>\u4ECB\u7ECD</h3><p>ActionSheet \u52A8\u4F5C\u9762\u677F</p><h3>\u5B89\u88C5\u4F7F\u7528</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> ActionSheet <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkd/lib/action-sheet&quot;</span>;
...
</code></pre>`,28),e=[c],d={},j="",i=a({__name:"doc.zh-CN",setup(o,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(u,h)=>(l(),n("div",p,e))}});export{i as default,j as excerpt,d as frontmatter};
