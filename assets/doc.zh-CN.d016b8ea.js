import{d as a,c as n,a as t,o as l}from"./vue.6ac91916.js";const p={class:"markdown-body"},e=t(`<h1>ShareSheet</h1><h3>\u4ECB\u7ECD</h3><p>ShareSheet \u5206\u4EAB\u9762\u677F</p><h3>\u5B89\u88C5</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> ShareSheet <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkd/lib/sharesheet&quot;</span>;
...
</code></pre>`,19),c=[e],d={},i="",j=a({__name:"doc.zh-CN",setup(o,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(u,h)=>(l(),n("div",p,c))}});export{j as default,i as excerpt,d as frontmatter};
