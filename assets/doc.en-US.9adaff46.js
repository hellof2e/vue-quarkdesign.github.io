import{d as a,c as n,a as l,o as t}from"./vue.57fd0b66.js";const p={class:"markdown-body"},e=l(`<h1>Overlay</h1><h3>Intro</h3><p>Create a mask layer to emphasize specific page elements and prevent users from performing other operations.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> <span class="hljs-string">&quot;quarkd/lib/overlay&quot;</span>;
...
</code></pre><h2>API</h2><h3>Props</h3><table><thead><tr><th>Attribute</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td>open</td><td>Whether to show picker</td><td><code class="">boolean</code></td><td><code class="">require</code></td></tr><tr><td>zindex</td><td>z-index</td><td><code class="">number </code></td><td><code class="">999</code></td></tr></tbody></table><h3>Events</h3><table><thead><tr><th>Event</th><th>Description</th><th>Type</th></tr></thead><tbody><tr><td>close</td><td>Close mask</td><td><code class="">() =&gt; void</code></td></tr></tbody></table><p>|</p><h2>CSS Variables</h2><p>The component provides the following<a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/Using_CSS_custom_properties">CSS variables</a>,which can be used to customize styles. Please refer to <a href="#/zh-CN/guide/theme">Theme customization</a>\u3002</p><table><thead><tr><th>Name</th><th>Description</th><th>Default Value</th></tr></thead><tbody><tr><td><code class="">--overlay-background</code></td><td>Mask background</td><td><code class="">rgba(0, 0, 0, 0.7)</code></td></tr></tbody></table>`,20),c=[e],j={},i="",g=a({__name:"doc.en-US",setup(h,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(o,r)=>(t(),n("div",p,c))}});export{g as default,i as excerpt,j as frontmatter};
