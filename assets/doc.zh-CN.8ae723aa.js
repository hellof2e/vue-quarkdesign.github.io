import{d as a,c as n,a as l,o as p}from"./vue.a353d86e.js";const t={class:"markdown-body"},c=l(`<h1>Form \u8868\u5355</h1><h3>\u4ECB\u7ECD</h3><p>\u8868\u5355</p><h3>\u5B89\u88C5\u4F7F\u7528</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> <span class="hljs-string">&quot;quarkd/lib/form&quot;</span>;
...
</code></pre><pre><code class="language-js"><span class="hljs-comment">// \u5728onMounted\uFF08vue3 setup\uFF09 \u6216 mounted\uFF08\u7EC4\u4EF6\u914D\u7F6E\uFF09\u94A9\u5B50\u4E2D</span>
<span class="hljs-comment">// \u8BBE\u7F6E\u8868\u5355\u9A8C\u8BC1\u89C4\u5219</span>
<span class="hljs-built_in">this</span>.$refs.form1.setRules = ([
  { <span class="hljs-attr">name</span>: <span class="hljs-string">&#39;name&#39;</span>, <span class="hljs-attr">required</span>: <span class="hljs-literal">true</span>, <span class="hljs-attr">message</span>: <span class="hljs-string">&#39;\u59D3\u540D\u5FC5\u586B&#39;</span> },
  { <span class="hljs-attr">name</span>: <span class="hljs-string">&#39;password&#39;</span>, <span class="hljs-attr">required</span>: <span class="hljs-literal">true</span>, <span class="hljs-attr">type</span>: <span class="hljs-string">&#39;password&#39;</span>, <span class="hljs-attr">message</span>: <span class="hljs-string">&#39;\u5BC6\u7801\u5FC5\u586B&#39;</span> }
]);
...
</code></pre><h2>API</h2><h3>Method</h3><table><thead><tr><th>\u540D\u79F0</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th></tr></thead><tbody><tr><td>getValues</td><td>\u63D0\u4EA4\u5E76\u6821\u9A8C\u8868\u5355\u83B7\u53D6\u6240\u6709\u7EC4\u4EF6\u7684 value</td><td><code class="">() =&gt; Promise&lt;value: any[]&gt;</code></td></tr><tr><td>setRules</td><td>\u53EA\u5BF9 field \u7EC4\u4EF6\u6709\u6548</td><td><code class="">(rule: Rule[])=&gt;void</code></td></tr></tbody></table><h3>\u7C7B\u578B\u5B9A\u4E49</h3><pre><code class="language-js">type Rule = {
