import{d as a,c as n,a as l,o as t}from"./vue.e8fb8c15.js";const p={class:"markdown-body"},c=l(`<h1>Form</h1><h3>Intro</h3><p>Form</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> <span class="hljs-string">&quot;quarkd/lib/form&quot;</span>;
...
</code></pre><pre><code class="language-js"><span class="hljs-comment">// in onMounted (vue3 setup) or mounted(component option) hook</span>
<span class="hljs-comment">// set form validation rules</span>
<span class="hljs-built_in">this</span>.$refs.form1.setRules = ([
  { <span class="hljs-attr">name</span>: <span class="hljs-string">&#39;name&#39;</span>, <span class="hljs-attr">required</span>: <span class="hljs-literal">true</span>, <span class="hljs-attr">message</span>: <span class="hljs-string">&#39;name required&#39;</span> },
  { <span class="hljs-attr">name</span>: <span class="hljs-string">&#39;password&#39;</span>, <span class="hljs-attr">required</span>: <span class="hljs-literal">true</span>, <span class="hljs-attr">type</span>: <span class="hljs-string">&#39;password&#39;</span>, <span class="hljs-attr">message</span>: <span class="hljs-string">&#39;password required&#39;</span> }
]);
<span class="hljs-function"><span class="hljs-title">submit1</span>(<span class="hljs-params"></span>)</span> {
  <span class="hljs-built_in">this</span>.$refs.form1.getValues().then(<span class="hljs-function">(<span class="hljs-params">value</span>) =&gt;</span> {
    <span class="hljs-built_in">console</span>.log(value, <span class="hljs-string">&#39;current form values&#39;</span>);
  }).catch(<span class="hljs-function"><span class="hljs-params">firstErrRule</span> =&gt;</span> {
...
<span class="hljs-tag">&lt;/<span class="hljs-name">quark-form</span>&gt;</span>
  ...
  <span class="hljs-function"><span class="hljs-title">submit2</span>(<span class="hljs-params"></span>)</span> {
    <span class="hljs-built_in">this</span>.$refs.form2.getValues().then(<span class="hljs-function">(<span class="hljs-params">value</span>) =&gt;</span> {
      <span class="hljs-built_in">console</span>.log(value, <span class="hljs-string">&#39;current form values&#39;</span>);
...
<span class="hljs-tag">&lt;/<span class="hljs-name">quark-form</span>&gt;</span>
      ...
      <span class="hljs-built_in">this</span>.$refs.form3.getValues().then(<span class="hljs-function">(<span class="hljs-params">value</span>) =&gt;</span> {
...
</code></pre>`,21),e=[c],i={},u="",g=a({__name:"doc.en-US",setup(h,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(r,j)=>(t(),n("div",p,e))}});export{g as default,u as excerpt,i as frontmatter};
